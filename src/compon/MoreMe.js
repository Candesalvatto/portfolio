  ...
  return (
    <section>
     ...
     data-aos-easing="ease-in-sine">
      ...
      <a href="/assets/cv.pdf" download="cv.pdf"  className='button-view-projects'> DESCARGAR CV 🚀</a>
      </div>
        </div>
    </section>
  )
